...
<span class="task">Use the following starter code:
...
3. Inside each condition, call the function that aligns with that condition.</span>

<span class="task-header">Solution</span>
 (Hover right to see our solution) <span class="solution">
if(sensorVal >= 900) {
  high();
}
