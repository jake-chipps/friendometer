...
<span class="task">Copy the following code and upload it to your Circuit Playground. Open the Serial Monitor to see the current values of the buttons as you push them in and release. Try pushing one at a time and pushing them in together.</task>
...
<span class="task">Write a program that combines everything we have done so far. Below is a checklist of the things you need to have in your program.
...
- Part 3: The loop().
  ...
  - Delay 100 milliseconds.
    ...
    - Else,
      ...
      - Based on the state of the touch sensor, call the function associated with that value.</span>
