...
## Montana Standards
- <u>4.OA.3</u> Solve multi-step word problems within cultural contexts, including those of Montana American Indians, with whole numbers and having whole-number answers using the four operations, including problems in which remainders must be interpreted. Assess the reasonableness of answers using mental computation and estimation strategies including rounding.
