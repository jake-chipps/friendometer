...
The earliest encryption technique that we know of comes from ancient Rome – the Caesar shift. The Caesar shift starts at a letter (like A) and shifts three to the right. If you start counting three to the right of A, you get D. So, A would be encoded as D. What would Y become? We start one to the right of Y, and then circle back to A and keep going.

Although the Caesar shift is a shift of three, there are twenty six other possible
shifts! For example, shifting 19 would mean that A (1) would become (T) 20. The
shift wheel below shows a right shift of 19 for all letters.
